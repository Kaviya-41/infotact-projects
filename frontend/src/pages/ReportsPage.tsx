/**
 * ReportsPage.tsx – Reports placeholder (coming soon).
...
const ReportsPage: React.FC = () => (
  ...
  >
    <div className="dashboard-section-label">
      ...
      <div>
        <h2 className="section-label-title">Reports</h2>
        <p className="section-label-subtitle">Fleet performance analytics &amp; exports</p>
      </div>
    </div>
    ...
    >
      ...
      <p style={{ color: '#8DA2C0', fontSize: '14px', maxWidth: '420px', margin: '0 auto', lineHeight: 1.7 }}>
        Comprehensive fleet analytics, trip summaries, fuel usage breakdowns,
        and exportable performance reports are currently under development.
      </p>
      <div style={{
        marginTop: '28px',
        display: 'inline-flex',
